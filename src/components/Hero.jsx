  ...
  return (
    <section className={`relative w-full h-screen mx-auto`}>
      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} lg:text-[70px]  text-white`}>
            Hi, I'm <span className='text-[#915EFF]'>Manpreet</span>
          </h1>
          <p className={`${styles.heroSubText}  lg:text-[24px] mt-2 text-white-100`}>
